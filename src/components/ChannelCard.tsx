          ...
          <div className="absolute inset-0 flex items-center justify-center p-6 sm:p-8">
            {channel.logo ? (
              <img
                ...
                loading="lazy"
                decoding="async"
                className="relative z-10 block max-w-[92%] max-h-[84%] w-auto h-auto object-contain drop-shadow-[0_12px_30px_rgba(0,0,0,.55)] transition-transform duration-500 group-hover:scale-[1.05]"
              />
            ) : (
